...
fetch('https://r.jina.ai/https://www.example.com', { //Jina Reader API, input any URL return 
    method: 'GET',
    headers: {
...
/* tool call one example usage idea <tool>{"tool":"jina","type":"search","queries":["Jina AI","Jina"]}</tool>
    tool call two example usage idea <tool>{"tool":"jina","type":"read","text":"Long text to summarize..."}</tool>
*/