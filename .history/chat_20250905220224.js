...
- Use tools for some web searches when needed. Limited to wikipedia and DuckDuckGo instant answers due to api 
...
- Tool: multi_source_search
  ...
  - Exact call format (no extra text in the same message):
    name: "multi_source_search"
    arguments:
    {
      "queries": ["<entity or term>", "<optional second term>"],
      "codingRelated": true|false,
      "perSource": 5,
      "region": "us-en",
      "safe": "moderate",
      "timeoutMs": 6000
