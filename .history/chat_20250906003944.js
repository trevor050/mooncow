...
- ALWAYS END THE TURN AFTER A TOOL CALL. THIS WILL ALLOW TIME FOR TOOL EXECUTION, AFTERWARDS YOU WILL CONTINUE WITH THE INFORMATION FROM THE TOOL CALL.
- ALWAYS MAKE TOOL CALLS AT THE START OF RESPONSE NOT IN THE MIDDLE OR END.
`;
}
