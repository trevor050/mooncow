...
async function getApiKey() {
    try {
        ...
        throw nError details

Protocol error (Error): background.service_worker is currently disabled. Add background.scripts. from: server0.conn3.webExtensionDescriptor22 (resource://gre/modules/Schemas.sys.mjs:300:13)ew Error('Missing Cerebras API Key');
    }
}
