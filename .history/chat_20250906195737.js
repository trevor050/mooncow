...
#IMPORTANT TOOL USAGE RULE: UNLESS the query requires speficifc up to date info (i.e whats the news this week) you may only use ONE tool call per user turn unless the user tells you to do otherwise (infer. If they use terms like: think deeply, research hard, ).
