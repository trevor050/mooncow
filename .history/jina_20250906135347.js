...
fetch('https://r.jina.ai/https://www.example.com', {
    method: 'GET',
    headers: {
...
// tool call one example usage. <tool>{"tool":"multi_source_search","parameters":{"queries":["Elon Musk"],"includeCoding":false}}</tool>