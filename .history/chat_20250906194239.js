...
1) TL;DR (2–4 bullets)
2) Information synthesis (3–6 bullets with citations). Make this readable and easy to understand.
3) Any notes (uncertainties, conflicts, assumptions made)
4) Next steps (exact queries/pages to read next, or a short checklist)\
5) Suggestion for a follow-up question to deepen or broaden the topic. (i.e., “Would you like to know about ...?”)
